...
const features = [
  {
    ...
    description:
      "Strategically located properties in high-growth areas with excellent connectivity and amenities.",
  },
  {
    icon: <LuRuler className="w-10 h-10 text-teal-600" />,
    title: "Expansive Plots",
    description:
      "Generous land parcels designed to accommodate luxury estates with ample space for landscaping.",
  },
  {
    icon: <FaAward className="w-10 h-10 text-teal-600" />,
    title: "Premium Investment",
    description:
      "High-value land assets with strong appreciation potential and exclusive ownership benefits.",
  },
  {
    icon: <FaLeaf className="w-10 h-10 text-teal-600" />,
    title: "Sustainable Development",
    description:
      "Environmentally conscious planning with preservation of natural features and green spaces.",
  },
];
    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          >
            Discover our portfolio of premium land properties designed for those
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div ref={ref} className="space-y-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="feature-item flex gap-6 opacity-0 translate-y-10"
              >
                <div className="flex-shrink-0 p-2 md:p-4 rounded-xl bg-teal-50 border border-teal-100">
                  {feature.icon}
                </div>
                <div>
                  <h3 className="text-base md:text-xl lg:text-2xl font-semibold text-slate-800 mb-2">
                    {feature.title}
                  </h3>
                  <p className="text-xs md:text-lg lg:text-xl text-slate-600">
                    {feature.description}
                  </p>
                </div>
              </div>
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="absolute -bottom-6 -right-6 bg-white p-2 lg:p-6 rounded-xl shadow-xl">
                <div className="text-xl lg:text-3xl font-bold text-teal-700">
                  250+ Acres
                </div>
                <div className=" text-sx lg:text-lg text-slate-600">
                  Premium Land Available
                </div>
              </div>
            </motion.div>
          </div>
